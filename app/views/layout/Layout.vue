<template>
    <div class="app-wrapper" v-bind:class="{ resizeCursor: isResizing }"
    ...
    methods: {
        ...
        onMouseDown(event) {
            if (event.target.id === 'ExplorerSash') {
                ...
                this.isExplorerResizing = true;
            } else if (event.target.id === 'SideContentSash') {
                this.isResizing = true;
                this.isSideContentResizing = true;
            }
        },
        ...
        onMouseUp() {
            if (this.isExplorerResizing) {
                ...
                this.isExplorerResizing = false;
            } else if (this.isSideContentResizing) {
                this.isResizing = false;
                this.isSideContentResizing = false;
            }
        },
